...
PARSER_LOCATION = root_directory.joinpath(f"CodeBLEU{_split}parser{_split}my-languages.so")
if CURRENT_OS == 'Windows':
    PARSER_LOCATION = str(root_directory.joinpath(f"CodeBLEU{_split}parser{_split}my-languages.dll"))
